    ...
    public function run()
    {
        ...
        $submenu = [
            ...
            [ //行銷策展
                ...
                ['sort' => 2, 'is_on' => 0, 'url_type' => 1, 'open_window' => 0, 'power_action' => 'N,M,O', 'allow_roles' => 'develop,admin,staff', 'icon' => '<i class="nav-icon fas fa-bullhorn"></i>', 'name' => '推薦碼設定', 'url' => 'referCodes',  'func_code' => 'referCodes'],
                ['sort' => 3, 'is_on' => 0, 'url_type' => 1, 'open_window' => 0, 'power_action' => 'N,M,O', 'allow_roles' => 'develop,admin,staff', 'icon' => '<i class="nav-icon fas fa-bullhorn"></i>', 'name' => '優惠活動設定', 'url' => 'promotions',  'func_code' => 'promotions'],
                ['sort' => 4, 'is_on' => 0, 'url_type' => 1, 'open_window' => 0, 'power_action' => 'N,M,O', 'allow_roles' => 'develop,admin,staff', 'icon' => '<i class="nav-icon fas fa-bullhorn"></i>', 'name' => '促銷代碼設定', 'url' => 'promoCodes',  'func_code' => 'promoCodes'],
