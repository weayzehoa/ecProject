    ...
    public function run()
    {
        ...
        $submenu = [
            ...
            [ //行銷策展
                ...
                ['sort' => 8, 'is_on' => 1, 'url_type' => 1, 'open_window' => 0, 'power_action' => 'N,M,O', 'allow_roles' => 'develop,admin,staff', 'icon' => '<i class="nav-icon  fab fa-elementor"></i>', 'name' => '菜單資訊', 'url' => 'foodmenus',  'func_code' => 'foodmenus'],
                ['sort' => 9, 'is_on' => 1, 'url_type' => 1, 'open_window' => 0, 'power_action' => 'N,M,O', 'allow_roles' => 'develop,admin,staff', 'icon' => '<i class="nav-icon  fas fa-store-alt"></i>', 'name' => '分店資訊', 'url' => 'stores',  'func_code' => 'stores'],
