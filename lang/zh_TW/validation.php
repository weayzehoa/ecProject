...
return [
    ...
    'attributes' => [
        'company' => [
            ...
            'name_en' => '公司英文名稱',
            'brand' => '品牌名稱',
            'tax_num' => '統一編號需為 8 位數字',
            'tel' => '請輸入正確的電話格式，例如 02-2223-3223 或 0372334231',
            'fax' => '請輸入正確的傳真格式，例如 02-2223-3223 或 0372334231',
            'address' => '中文地址',
            'address_en' => '英文地址',
            'service_tel' => '客服電話',
            'service_email' => '客服信箱',
            ...
            'website' => '請輸入正確的網址格式（不含 https://）',
            'url' => '請輸入正確的網址格式（含 https://）',
            'fb_url' => '請輸入 Facebook 粉絲頁連結',
            'Instagram_url' => '請輸入 Instagram 粉絲頁連結',
            'line' => 'Line ID',
            'line_qrcode' => 'Line QrCode 網址',
            'lon' => '經度座標',
            'lat' => '緯度座標',
            'wechat_id' => '微信 ID',
        ],
