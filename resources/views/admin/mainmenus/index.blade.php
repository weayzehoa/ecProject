            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ url('mainmenu') }}">選單功能設定</a></li>
                    ...
                    <div class="card">
                            ...
                            <div class="float-left">
                                <div class="input-group">
                                    <div class="input-group-append">
                                        <a href="{{ route('admin.mainmenus.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus mr-1"></i>新增主選單</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover table-sm">
                                <thead>
                                    <tr>
                                        <th class="text-center" width="6%">順序</th>
                                        <th class="text-center" width="8%">選單代碼</th>
                                        <th class="text-left" width="8%">功能代碼</th>
                                        <th class="text-center" width="8%">FA5圖示</th>
                                        <th class="text-left" width="12%">主選單名稱</th>
                                        <th class="text-center" width="12%">連結類型</th>
                                        <th class="text-left" width="18%">連結網址</th>
